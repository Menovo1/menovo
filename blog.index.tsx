  ...
  head: () => ({
    meta: [
      { title: "Digital Strategy & Growth Insights | MENOVO" },
      {
        name: "description",
        content:
          "Business website design, SEO & digital growth, direct bookings, business marketing and digital customer experience insights from MENOVO.",
      },
      { business: "og:title", content: "Journal — Digital Experience Insights | MENOVO" },
      {
        business: "og:description",
        content: "Practical insights on business website design, SEO, direct bookings and digital marketing for business businesses.",
      },
