...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MENOVO is a digital agency creating premium, fast and mobile-friendly websites and digital experiences for businesses and organizations worldwide." },
      { name: "author", content: "MENOVO" },
      { name: "theme-color", content: "#001229" },
      { business: "og:title", content: "Digital Agency | MENOVO" },
      { business: "og:description", content: "MENOVO is a digital agency creating premium, fast and mobile-friendly websites and digital experiences for businesses and organizations worldwide." },
      ...
      { name: "twitter:description", content: "MENOVO is a digital agency creating premium, fast and mobile-friendly websites and digital experiences for businesses and organizations worldwide." },
