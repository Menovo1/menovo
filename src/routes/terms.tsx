    ...
    <div className="pt-28">
      <Section eyebrow="Legal" title="Terms of Service">
        <div className="prose prose-invert max-w-3xl text-foreground/85 space-y-4">
          ...
          <p>Support windows are defined per package. Extended support is available on request. For any questions, contact <a className="text-gold" href="mailto:2MENOVO@gmail.com">2MENOVO@gmail.com</a>.</p>
        </div>
      </Section>
    </div>
  ),
