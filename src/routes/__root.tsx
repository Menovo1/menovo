...
export const Route = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MENOVO is a hotel web design agency creating premium, fast and mobile-friendly hotel websites for hospitality businesses worldwide." },
      { name: "author", content: "MENOVO" },
      { name: "theme-color", content: "#001229" },
      { property: "og:title", content: "Hotel Web Design Agency | MENOVO" },
      { property: "og:description", content: "MENOVO is a hotel web design agency creating premium, fast and mobile-friendly hotel websites for hospitality businesses worldwide." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "MENOVO" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Hotel Web Design Agency | MENOVO" },
      { name: "twitter:description", content: "MENOVO is a hotel web design agency creating premium, fast and mobile-friendly hotel websites for hospitality businesses worldwide." },
