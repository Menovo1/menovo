...
export const Route = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Digital Agency | MENOVO" },
      { property: "og:description", content: "MENOVO is a digital agency creating premium, fast and mobile-friendly business websites for businesses worldwide." },
