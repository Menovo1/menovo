    ...
    <div className="pt-28">
      <Section eyebrow="Legal" title="Privacy Policy">
        <div className="prose prose-invert max-w-3xl text-foreground/85 space-y-4">
          ...
          <p>We do not sell your data. We do not share it with third parties except as required to operate our services (e.g. email delivery). You may request deletion of your data at any time by contacting <a className="text-gold" href="mailto:2MENOVO@gmail.com">2MENOVO@gmail.com</a>.</p>
