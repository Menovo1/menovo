...
export function Footer() {
  return (
    <footer className="relative mt-16 border-t border-gold/15">
      <div className="absolute inset-x-0 -top-px h-px bg-gradient-to-r from-transparent via-gold/50 to-transparent" />
      <div className="mx-auto max-w-7xl px-5 sm:px-8 py-8 grid gap-6 sm:grid-cols-2 items-start">
        <div>
          <div className="font-display font-bold text-lg text-gradient-gold">MENOVO</div>
          <p className="mt-2 text-xs text-muted-foreground max-w-sm leading-relaxed">
            From Table to Screen — websites & QR menus for hotels, restaurants and cafés.
          </p>
